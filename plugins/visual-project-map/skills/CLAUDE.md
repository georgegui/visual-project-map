...
## Skills
- **`visualize-project/`** — Main generation skill. Scans a project (describe), designs a workflow (initialize), or proposes restructuring (refactor). Complex: 3 phases, foundation tables, worked examples.
